...
文献【3】和【21】都使用了“线性化”技术简化问题。文献【3】主张局部波动率仅是价格的函数，即 $\sigma^2(s) = \sigma_0^2 + 2f_*(s)$，文献【21】进一步发展线性化技术，主张 $\sigma^2(s) = \sigma_0^2 + 2f_0^*(s)+ 2f_1^*(s)t$（$\sigma_0$ 是常数），二者都提出了快速校准“扰动函数” $f$ 的算法。
